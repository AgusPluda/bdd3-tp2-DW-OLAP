...
CREATE TABLE Mercaderias (
  ...
  es_carga_peligrosa BIT NOT NULL
);
...
CREATE TABLE Programaciones_Par_Puertos (
  ...
  FOREIGN KEY (puerto_de_llamada_id) REFERENCES Puertos_de_Llamada_Viajes(puerto_de_llamada_id),
...
CREATE TABLE Contratos (
  ...
  FOREIGN KEY (par_puertos_programado) REFERENCES Programaciones_Par_Puertos(par_puertos_programado_id)
);
